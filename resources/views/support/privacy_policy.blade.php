    ...
    <div class="d-flex flex-column flex-column-fluid">
        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                {{--                    <a href="{{env('BASE_URL').'policy'}}" class="btn btn-sm fw-bold btn-primary">--}}
                                ...
                                <div class="col-md-12 pe-lg-10">
                                    ...
                                    <form action="#" class="form mb-15" method="post">
                                        ...
                                        <div class="row mb-8">
                                            <div class="col-12">
                                                ...
                                                <div name="description" id="description"
                                                     class="min-h-200px max-h-300px mb-2 description">{!! $policy->description ?? "" !!}</div>
                                                <!--end::Editor-->
                                                <!--begin::Description-->
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <!--begin::Actions-->
                                                <input type="hidden" id="id" value="{{ $policy->id ?? "" }}">
                                                <div class="text-center">
                                                    {{--                                                        <button type="reset" id="reset_form"--}}
                                                    {{--                                                                class="btn btn-light me-3">Reset--}}
                                                    {{--                                                        </button>--}}
                                                    <button type="submit"
                                                            class="btn btn-primary submit-btn" id="policy-save-btn">
...
@section('page_level_scripts')
    <script type="text/javascript">
        $(document).on('click', '#policy-save-btn', function (e) {
            e.preventDefault();
            do_post_ajax({
                'api_hook': 'support/privacy-policy/update',
                'data': getPolicyFormData(),
            });
        });
