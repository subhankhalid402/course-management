...
@section('page_title','Edit Office')
@section('content')
        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="d-flex align-items-center gap-2 gap-lg-3">
                    ...
                    <a href="{{env('BASE_URL').'offices'}}" class="btn btn-sm fw-bold btn-primary">
                                    ...
                                    <form action="#" class="form mb-15" method="post">
                                        ...
                                        <div class="row g-3 mb-8">
                                            ...
                                            <div class="col-md-4 fv-row">
                                                ...
                                                <input type="text" class="form-control form-control-solid"
                                                       placeholder="Enter name" name="name" id="name" value="{{ $office->name }}"/>
                                            </div>
                                            <!--end::Col-->
                                            ...
                                            <div class="col-md-4 fv-row">
                                                ...
                                                <input type="text" class="form-control form-control-solid"
                                                       placeholder="Enter phone" name="phone" id="phone" value="{{ $office->phone }}"/>
                                            </div>
                                            <!--end::Col-->
                                            ...
                                            <div class="col-md-4 fv-row">
                                                ...
                                                <input type="text" class="form-control form-control-solid"
                                                       placeholder="Enter owner phone" name="cell" id="cell" value="{{ $office->owner->phone }}"/>
                                            </div>
                                            <!--end::Col-->
                                        </div>
                                        <!--end::Row-->
                                        ...
                                        <div class="row g-3 mb-8">
                                            ...
                                            <div class="col-md-4 fv-row">
                                                ...
                                                <input type="text" class="form-control form-control-solid"
                                                       placeholder="Enter Owner name" name="owner_name" id="owner_name" value="{{ $office->owner->name }}"/>
                                            </div>
                                            <!--end::Col-->
                                            ...
                                            <div class="col-md-4 fv-row">
                                                ...
                                                <input type="email" class="form-control form-control-solid"
                                                       placeholder="Email" name="email" id="email" value="{{ $office->owner->email }}"/>
                                            </div>
                                            ...
                                            <div class="col-md-8 fv-row">
                                                ...
                                                <input type="text" class="form-control form-control-solid"
                                                       placeholder="Enter address" name="address" id="address" value="{{ $office->address }}"/>
                                            </div>
                                            <!--end::Col-->
                                            <!--begin::Col-->
                                            <div class="col-md-4 fv-row">
                                                ...
                                                <select data-control="select2"
                                                    ...
                                                    @foreach($countries as $country)
                                                        <option {{ $country->id == $office->country_id ? "selected" : ""}} value="{{ $country->id }}">{{ $country->nice_name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <!--end::Col-->
                                        ...
                                        <div class="row g-3 mb-8">
                                            ...
                                            <div class="col-md-12 fv-row">
                                                ...
                                                <textarea class="form-control form-control-solid" rows="6"
                                                          name="notes" id="notes" placeholder="Type any additional information here...">{{ $office->notes }}</textarea>
                                            </div>
                                            <!--end::Col-->
                                        </div>
                                        <!--end::Row-->
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <!--begin::Actions-->
                                                <input type="hidden" id="id" value="{{$office->id}}">
